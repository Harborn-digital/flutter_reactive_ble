...
class PluginController {
    ...
    private fun executeWriteAndPropagateResultToChannel(
        ...
        System.out.println("writeCharMessage = " + writeCharMessage.value.toByteArray())
        bleClient.writeOperation(
            ...
            .subscribe({ operationResult ->
                System.out.println("operationResult = " + operationResult.toString())
    ...
    private fun discoverServices(call: MethodCall, result: Result) {
        ...
        bleClient.clearGattCache(request.deviceId)
            .andThen(bleClient.discoverServices(request.deviceId))
            .observeOn(AndroidSchedulers.mainThread())
